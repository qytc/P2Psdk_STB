...
public class ConfBean {
    ...
    private int broadcastMultiScreen;
    private int broadcastParticipants;
    ...
    public int getBroadcastMultiScreen() {
        return broadcastMultiScreen;
    }

    public void setBroadcastMultiScreen(int broadcastMultiScreen) {
        this.broadcastMultiScreen = broadcastMultiScreen;
    }

    public int getBroadcastParticipants() {
        return broadcastParticipants;
    }

    public void setBroadcastParticipants(int broadcastParticipants) {
        this.broadcastParticipants = broadcastParticipants;
    }
